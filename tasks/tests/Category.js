...
describe('POST /category/:id/update', function () {
    ...
    it('categoria inexistente', function (done) {
        api.post('tasks', '/category/inexistente/update', {token : user.token, name : 'Categoria', type : 'general', color : 'blue'}, function (error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'NotFoundError');
    ...
    it('altera categoria', function (done) {
        api.post('tasks', '/category/' + category._id + '/update', {token : user.token, name : 'Categoria', type : 'general', color : 'blue'}, function (error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('category').property('name', 'Categoria');
...
describe('POST /category/:id/delete', function () {
    ...
    it('categoria inexistente', function (done) {
        api.post('tasks', '/category/inexistente/delete', {token : user.token}, function (error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'NotFoundError');
    ...
    it('deleta categoria', function (done) {
        api.post('tasks', '/category/'+category._id+'/delete', {token : user.token}, function (error, data, response) {
            if (error) {
                return done(error);
            } else {
                should.not.exist(data);
                api.post('tasks', '/user', {token : user.token}, function (error, data, response) {
