                    ...
                    for (var j in cohort[i].users) {
                        if (
                            (
                                ...
                                cohort[i].users[j].ocurrences('tarefas', ['adicionar tarefa']) >= 1 ||
                                cohort[i].users[j].ocurrences('finanças', ['adicionar transação']) >= 1 ||
                                cohort[i].users[j].ocurrences('contatos', ['adicionar contato']) >= 1
                            )
                        ) {
