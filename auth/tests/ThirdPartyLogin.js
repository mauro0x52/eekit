...
describe('POST /user/[id]/third-party-login/delete', function () {
    var token,
        userId,
        third;
    ...
    it('página não encontrada', function (done) {
        api.post('auth', '/user/'+userId+'/third-party-login/'+third+'/delete', {}, function (error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token errado', function (done) {
        api.post('auth', '/user/'+userId+'/third-party-login/'+third+'/delete', {token : 'tokeninvalido'}, function (error, data, response) {
            if (error) {
                done(error);
            } else {
                data.should.have.property('error').have.property('name', 'InvalidTokenError');
    ...
    it('usuário inexistente', function (done) {
        api.post('auth', '/user/inexistente/third-party-login/' + third + '/delete', {}, function (error, data, response) {
            if (error) {
                done(error);
            } else {
                data.should.have.property('error').have.property('name', 'NotFoundError');
    ...
    it('third party login inexistente', function (done) {
        api.post('auth', '/user/' + userId + '/third-party-login/inexistente/delete', {token : token}, function (error, data, response) {
            if (error) {
                done(error);
            } else {
                data.should.have.property('error').have.property('name', 'NotFoundError');
    ...
    it('remove login externo', function (done) {
        api.post('auth', '/user/'+userId+'/third-party-login/delete' + third, {token : token}, function (error, data, response) {
            if (error) {
                done(error);
            } else {
