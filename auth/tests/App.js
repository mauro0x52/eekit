...
describe('POST /user/[login]/app/[app_id]/delete', function () {
    var token,
        userId,
        tokenApp,
        appId,
    ...
    it('página não existe', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/delete', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/delete', {token : 'tokeninválido'}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').have.property('name', 'InvalidTokenError');
    ...
    it('usuário inexistente', function(done) {
        api.post('auth', '/user/inexistente/app/'+appId+'/delete', {
            token : token
        }, function(error, data, response) {
    ...
    it('remoção da autenticação', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/delete', {
            token : token
        }, function(error, data, response) {
            if (error) {
                return done(error);
...
describe('POST /user/[login]/app/[app_id]/update', function () {
    var token,
        userId,
        tokenApp,
        appId,
    ...
    it('página não existe', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/update', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/update', {token : 'tokeninválido'}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').have.property('name', 'InvalidTokenError');
    ...
    it('usuário inexistente', function(done) {
        api.post('auth', '/user/inexistente/app/'+appId+'/update', {
            token : token
        }, function(error, data, response) {
            if (error) return done(error);
            else {
    ...
    it('aplicativo inexistente', function(done) {
        api.post('auth', '/user/'+userId+'/app/inexistente/update', {
            token : token
        }, function(error, data, response) {
            if (error) return done(error);
            else {
    ...
    it('edição da autenticação', function(done) {
        api.post('auth', '/user/'+userId+'/app/'+appId+'/update', {
            token : token,
