...
module.exports = function (app) {
    ...
    /** POST /user/:login/app/:app_id/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-07
     *
     ...
     */
    app.post('/user/:login/app/:id/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
     ...
     */
    app.get('/user/apps', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
    ...
    /** POST /user/:login/app/:app_id/update
     *
     * @autor : Rafael Erthal
     * @since : 2012-07
     *
     ...
     * @response : {confirmation}
     */
    app.post('/user/:login/app/:id/update', function (request, response) {
        var i,
            authorizedApp,
            found = false;
