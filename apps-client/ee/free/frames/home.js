            ...
            /* wrapper */
            {
                ...
                html : [
                    /* frase */
                    {
                        ...
                        html : [
                            { tag : 'span', html : 'Experimente'},
                            { tag : 'span', html : ' grátis ', attributes : { style : 'color:#f08220;'}},
                            { tag : 'span', html : 'por 15 dias!'}
                        ]
                    },
                    /* subfrase */
                    {
                        ...
                        html : [
                            { tag : 'span', html : 'cadastre-se', attributes : { style : 'color:#f08220;'}},
                            { tag : 'span', html : ', leva menos que 30 segundos'}
                        ]
                    },
                    /* botão */
                    {
 ...
 */
    /* contatos */
    contacts_button = new app.ui.tag ({
        tag : 'a',
        html : 'CONTATOS',
        attributes : {
    ...
    /* finanças */
    finances_button = new app.ui.tag({
        tag : 'a',
        html : 'FINANÇAS',
        attributes : {
            style : app_button_style
 ...
 * -----------------------------------------------------------------------------
 */
    app.ui.html([header, content_header, content_signup, content_title, content_apps, footer_signup]);
});