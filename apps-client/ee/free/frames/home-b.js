...
app.routes.frame('/lp-02', function (params, data) {
            ...
            html : {
                ...
                html : [
                    ...
                    },
                    {
                        tag : 'h1',
                        attributes : {
                            style : 'position:absolute; left: 320px; color:#fff; font-size:28px; font-family:Arial,Helvetica,sans-serif; line-height:1.2em; top: 60px;'
                        },
                        html : 'Pare de passar o dia inteiro apagando incêndios'
                    }
                ]
            }
        },
