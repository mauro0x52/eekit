...
app.routes.frame('/lp-06', function (params, data) {
            ...
            html : {
                ...
                html : [
                    ...
                    },
                    {
                        tag : 'h1',
                        attributes : {
                            style : 'position:absolute; left: 320px; color:#fff; font-size:22px; font-family:Arial,Helvetica,sans-serif; line-height:1.2em; top: 60px;'
                        },
                        html : 'Pare de se aborrecer com planilhas e invista mais tempo nos seus clientes'
                    }
                ]
            }
        },
                        ...
                        html : [
                            {
                                tag : 'div',
                                attributes : {
                                    style : 'font-size:14px; color:#332f2f;'
                                }
                            },
                            {
                                tag : 'div',
