...
describe('POST /profile/[slug]/contact/[id]/delete', function () {
    var token,
        slug,
        version,
        profile,
    ...
    it('url tem que existir', function(done) {
        api.post('profiles', '/profile/' + profile + '/contact/' + contact + '/delete', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('profiles', '/profile/' + profile + '/contact/' + contact + '/delete', {token : 'invalido'}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'InvalidTokenError');
    ...
    it('perfil inexistente', function(done) {
        api.post('profiles', '/profile/inexistente/contact/' + contact + '/delete', {token : token}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'NotFoundError');
    ...
    it('remove contato', function(done) {
        api.post('profiles', '/profile/' + profile + '/contact/' + contact + '/delete', {token : token}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
...
describe('POST /profile/[slug]/contact/[id]/update', function () {
    var token,
        slug,
        version,
        profile,
    ...
    it('url tem que existir', function(done) {
        api.post('profiles', '/profile/' + profile + '/contact/' + contact + '/update', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('profiles', '/profile/' + profile + '/contact/' + contact + '/update', {
            token : 'invalido',
            address   : 'Number ' + rand(),
            type      : 'twitter'
        }, function(error, data, response) {
    ...
    it('perfil inexistente', function(done) {
        api.post('profiles', '/profile/inexistente/contact/' + contact + '/update', {
            token : token,
            address   : 'Number ' + rand(),
            type      : 'twitter'
        }, function(error, data, response) {
