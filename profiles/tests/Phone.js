...
describe('POST /profile/[slug]/phone/[id]/delete', function () {
    var token,
        slug,
        version,
        profile,
    ...
    it('url tem que existir', function(done) {
        api.post('profiles', '/profile/' + profile + '/phone/' + phone + '/delete', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('profiles', '/profile/' + profile + '/phone/' + phone + '/delete', {token : 'invalido'}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'InvalidTokenError');
    ...
    it('perfil inexistente', function(done) {
        api.post('profiles', '/profile/inexistente/phone/' + phone + '/delete', {token : token}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                data.should.have.property('error').property('name', 'NotFoundError');
    ...
    it('remove telefone', function(done) {
        api.post('profiles', '/profile/' + profile + '/phone/' + phone + '/delete', {token : token}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
...
describe('POST /profile/[slug]/phone/[id]/update', function () {
    var token,
        slug,
        version,
        profile,
    ...
    it('url tem que existir', function(done) {
        api.post('profiles', '/profile/' + profile + '/phone/' + phone + '/update', {}, function(error, data, response) {
            if (error) {
                return done(error);
            } else {
                response.should.have.status(200);
    ...
    it('token inválido', function(done) {
        api.post('profiles', '/profile/' + profile + '/phone/' + phone + '/update', {
            token : 'invalido',
            street : "Rua " + rand(),
            number : "Numero " + rand(),
    ...
    it('perfil inexistente', function(done) {
        api.post('profiles', '/profile/inexistente/phone/' + phone + '/update', {
            token : token,
            street : "Rua " + rand(),
            number : "Numero " + rand(),
            complement : "Complemento " + rand(),
