...
module.exports = function (app) {
    ...
    /** POST /profile/:profile_id/thumbnail/update
     *
     * @autor : Mauro Ribeiro
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:profile_id/thumbnail/update', function (request, response) {
        response.header('Access-Control-Allow-Origin', '*');

        postProfileThumbnail(request, response);
    });

    /** POST /profile/:profile_id/thumbnail/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:profile_id/thumbnail/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
