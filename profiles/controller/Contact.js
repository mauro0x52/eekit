...
module.exports = function (app) {
    ...
    /** POST /company/:slug/contact/:id/update
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/contact/:id/update', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
    ...
    /** POST /company/:slug/contact/:id/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/contact/:id/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
