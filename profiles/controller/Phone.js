...
module.exports = function (app) {
    ...
    /** POST /profile/:slug/phone/:id/update
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/phone/:id/update', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
    ...
    /** POST /profile/:slug/phone/:id/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/phone/:id/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
