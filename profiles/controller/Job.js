...
module.exports = function (app) {
    ...
    /** POST /company/:slug/job/:id/update
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/job/:id/update', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
    ...
    /** POST /company/:slug/job/:id/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/job/:id/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
