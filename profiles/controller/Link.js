...
module.exports = function (app) {
    ...
    /** POST /profile/:slug/link/:id/update
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/link/:id/update', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
    ...
    /** POST /profile/:slug/link/:id/delete
     *
     * @autor : Rafael Erthal
     * @since : 2012-08
     *
     ...
     * @response : {confirmation}
     */
    app.post('/profile/:slug/link/:id/delete', function (request, response) {
        response.contentType('json');
        response.header('Access-Control-Allow-Origin', '*');
